# kata2-chop-binary-search

Clojure code for solving the kata 2 "Karate chop" from codekata.pragprog.com

## Description of kata2, Copyright for the source code Â© cf. codekata.pragprog.com
...
Copyright for the source code Â© 2013 Holger Schauer
